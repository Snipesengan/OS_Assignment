...
lift_sim_B: lift_sim_B.c lift.h buffer.h buffer.o
	$(CC) $(CFLAGS) $(LDFLAGS) buffer.o lift_sim_B.c -o lift_sim_B $(LDLIBS)

lift_sim_B_debug: lift_sim_B.c lift.h buffer.h buffer.o
...
lift_sim_A_debug: lift_sim_A.c lift.h buffer.o
	$(CC) $(CFLAGS) $(LDFLAGS) -DDEBUG buffer.o lift_sim_A.c -o lift_sim_A
